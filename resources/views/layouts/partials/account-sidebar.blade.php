            ...
            <x-ui.card class="!max-w-none border border-black/5 bg-white/70 shadow-sm dark:border-white/10 dark:bg-white/[0.03]">
                <div class="flex items-center gap-3">
                    ...
                    <div class="min-w-0">
                        ...
                        <x-ui.text size="sm" class="truncate text-neutral-500 dark:text-neutral-400">{{ '@'.$portalUser->username }}</x-ui.text>
                    </div>
                </div>
            </x-ui.card>
        </div>
        ...
        <div class="px-3 pb-3">
            <x-ui.dropdown portal position="top-start">
                ...
                <x-slot:menu class="!w-[15rem]">
                    ...
                    <livewire:auth.logout-button presentation="dropdown-item" :key="'account-sidebar-logout'" />
                </x-slot:menu>
            </x-ui.dropdown>
        </div>
    @endif
