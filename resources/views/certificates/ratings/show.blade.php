...
@section('title', ($certificateRating->name ?: 'Certificate rating').' archive')
@section('meta_description', 'Browse related certificate records, linked attributes, and other published titles that share the '.($certificateRating->name ?: 'selected').' rating.')

@section('breadcrumbs')
    <x-ui.breadcrumbs.item :href="route('public.home')">Home</x-ui.breadcrumbs.item>
    <x-ui.breadcrumbs.item>{{ $certificateRating->name ?: 'Certificate rating' }}</x-ui.breadcrumbs.item>
@endsection
                ...
                <div class="space-y-5">
                    ...
                    <div class="space-y-3">
                        <x-ui.heading level="h1" size="xl" class="sb-page-title">
                            {{ $certificateRating->name ?: 'Certificate rating' }}
                        </x-ui.heading>

                        <x-ui.text class="sb-page-copy max-w-4xl text-base">
                            Published certificate records using this rating, including linked attributes, origin countries, and other movies in the public archive.
                        </x-ui.text>
                    </div>
                </div>
