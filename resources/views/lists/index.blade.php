...
@section('content')
    <section class="space-y-5" data-slot="public-lists-shell">
        ...
        <div wire:loading.delay wire:target="search,sort" class="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        <div wire:loading.remove wire:target="search,sort" class="space-y-4" data-slot="public-lists-grid">
