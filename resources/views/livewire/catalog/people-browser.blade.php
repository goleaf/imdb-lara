...
<div class="space-y-4" data-slot="people-browser-island">
    ...
    <div class="space-y-4 has-data-loading:[&_[data-slot=people-browser-skeletons]]:grid has-data-loading:[&_[data-slot=people-browser-results]]:hidden">
        ...
        <div data-slot="people-browser-skeletons" class="hidden gap-4 sm:grid-cols-2 xl:grid-cols-3">
        ...
        <div class="sb-results-shell space-y-4 rounded-[1.6rem] p-4 sm:p-5" data-slot="people-browser-results">
