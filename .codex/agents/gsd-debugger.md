...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = ~/.codex
                  → checks /Users/andrejprus/Herd/imdb-lara/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/andrejprus/Herd/imdb-lara/.codex/get-shit-done
                  → writes to /Users/andrejprus/Herd/imdb-lara/.codex/get-shit-done/hooks/
...
```bash
INIT=$(node "/Users/andrejprus/Herd/imdb-lara/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/andrejprus/Herd/imdb-lara/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/andrejprus/Herd/imdb-lara/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
